...
- Name: visual-responsive.spec.ts >> Responsive Design - /experimental Route >> [desktop] MotionStrip touch target sizes (accessibility)
- Location: tests/visual-responsive.spec.ts:64:9
