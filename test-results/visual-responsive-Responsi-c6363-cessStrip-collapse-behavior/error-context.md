...
- Name: visual-responsive.spec.ts >> Responsive Design - /experimental Route >> [desktop] ExperimentalProcessStrip collapse behavior
- Location: tests/visual-responsive.spec.ts:31:9
